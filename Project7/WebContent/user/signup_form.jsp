...
<div class="container" >
   ...
   <form action="${pageContext.request.contextPath}/user/signup.jsp" method="post" id="regForm" enctype=multipart/form-data>
      ...
      <div class="form-group col-md-4">
         ...
         <h5><label for="userid">아이디(필수)</label></h5>
      ...
      <div class="form-group col-md-4">
         <h5><label for="userpw">비밀번호</label></h5>
      ...
      <div class="form-group col-md-4">
         <h5><label for="userphone">전화번호(필수)</label></h5>
         <input type="text" class="form-control" name="userphone" id="userphone" required/>

      </div>
      <div class="form-group col-md-4">
         <h5><label for="usergender">성별</label></h5>
         <select class="custom-select" name="usergender" id="usergender" >
