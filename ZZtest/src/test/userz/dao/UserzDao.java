...
import test.userz.dto.UserzDto;
import test.util.DbcpBean;

public class UserzDao {
	private static UserzDao dao;
	private UserzDao() {}
	public static UserzDao getInstance() {
		if(dao==null) {
			dao=new UserzDao();
		}
		return dao;
	...
	//회원정보 수정반영하는 메소드
		public boolean update(UserzDto dto) {
	...
	public UserzDto getData(String id) {
	...
	public boolean isValid(UserzDto dto) {
	...
	public boolean insert(UserzDto dto) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		int flag = 0;
		try {
